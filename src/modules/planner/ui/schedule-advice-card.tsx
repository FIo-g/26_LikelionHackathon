...
export const ScheduleAdviceCard = ({ advice }: { advice: ScheduleAdviceViewModel }) => {
  ...
  return <section className={styles.adviceCard} aria-labelledby="schedule-advice-title">
    ...
    <p>기상 목표: <time dateTime={advice.proposal.eventWakeAt}>{new Date(advice.proposal.eventWakeAt).toLocaleString("ko-KR")}</time></p>
